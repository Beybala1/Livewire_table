        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">İstifadəçini redaktə edin</h5>
                    <!-- component -->
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click.prevent="update" type="button"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Yenilə</button>
                </div>
            </div>
        </div>
    </div>